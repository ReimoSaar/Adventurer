...
public class Animation {
    ...
    public void drawAnimation(Graphics g2, double x, double y, int width, int height, ActionListener imageObserver){
        g2.drawImage(currentImg, (int)x, (int)y, width, height, (ImageObserver) imageObserver);
    }
